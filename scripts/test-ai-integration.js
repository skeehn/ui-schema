 ...
 * Tests the full flow: Prompt → AI → UISchema → Render
 */
...
log("\n🤖 Testing AI Integration", "blue");
log("=".repeat(50), "blue");

// Test 1: Mock AI Response → UISchema Conversion
log("\n📝 Test 1: Mock AI Response → UISchema", "blue");
...
log("\n📋 Test 2: Structured Output Format", "blue");
...
log("\n📡 Test 3: Streaming JSONL Patches", "blue");
...
log("\n🎨 Test 4: Coarse-to-Fine Generation", "blue");
test("Coarse layout → Fine refinement", () => {
...
log("\n💾 Test 5: Compressed Shorthand (Token Efficiency)", "blue");
test("AI generates shorthand → Expand to full schema", () => {
  ...
  log(`   📊 Token ratio: ${ratio.toFixed(2)}x (shorthand is ${(1/ratio*100).toFixed(0)}% of full JSON)`, "yellow");
});

// Test 6: Render AI-Generated Schema
log("\n🎭 Test 6: Render AI-Generated Schema", "blue");
...
log("\n🌉 Test 8: Spec Bridge Compatibility", "blue");
...
// Summary
log("\n" + "=".repeat(50), "blue");
log(`\n📊 AI Integration Test Results:`, "blue");
...
if (failed > 0) {
  log("\n❌ Some AI integration tests failed", "red");
  process.exit(1);
} else {
